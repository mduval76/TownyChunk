...
void Shader::UpdateIntUniform(GLint name, GLint value) {
	glUniform1i(name, value);
}

void Shader::UpdateFloatUniform(GLint name, GLfloat value) {
	glUniform1f(name, value);
}

void Shader::UpdateVec2Uniform(GLint name, GLfloat x, GLfloat y) {
	glUniform2f(name, x, y);
}

void Shader::UpdateVec3Uniform(GLint name, GLfloat x, GLfloat y, GLfloat z) {
	glUniform3f(name, x, y, z);
}

void Shader::UpdateVec3Uniform(GLint name, const Vector3f& vec) {
	glUniform3f(name, vec.x, vec.y, vec.z);
}

void Shader::UpdateVec4Uniform(GLint name, GLfloat x, GLfloat y, GLfloat z, GLfloat w) {
